...
chunks_dir = "/Users/walid/Desktop/Senior_Project/Admissions"
texts = []
file_paths = []
...
faiss.write_index(index, os.path.join(output_dir, "admission_index.faiss"))

with open(os.path.join(output_dir, "chunkA_metadata.json"), "w") as f:
